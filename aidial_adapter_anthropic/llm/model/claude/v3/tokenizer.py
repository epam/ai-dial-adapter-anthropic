...
def _tokenize_tool_system_message(
    ...
    # FIXME: return number of tokens depending of the deployment id
    # Default for "anthropic.claude-3-opus-20240229-v1:0"
...
def _tokenize(
    ...
    if tools := params["tools"]:
        ...
        tokens += _tokenize_tool_system_message(choice)
...
def create_tokenizer(
    ...
    async def _tokenizer(messages) -> int:
        return _tokenize(params, [msg for msg, _ in messages])
